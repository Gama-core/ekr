...
async def lifespan(app: FastAPI):
    logger.info("--- Fact Check Service Starting Up ---")
...
app = FastAPI(
    ...
    description="A microservice for finding factual inaccuracies in text using an LLM.",
    version="1.0.0",
    lifespan=lifespan
)
...
if __name__ == "__main__":
    logger.info(f"Starting Fact Check Service on http://{settings.APP_HOST}:{settings.APP_PORT}")
