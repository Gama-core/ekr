# app/features/elasticsearch/helpers.py
from .schemas import NoteForIndex

def build_es_document(note: NoteForIndex):
    """
    Convert a NoteForIndex Pydantic object into a dictionary for Elasticsearch indexing.
    """
    return {
        "note_id": note.id,
        "title": note.title,
