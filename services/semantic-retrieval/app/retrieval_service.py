...
async def retrieve_relevant_context(
    ...
    logger.info(
        f"Retrieval service: request for user_id: {user_id}, query: '{query_text[:50]}...'"
    )
    ...
    try:
        ...
        error_msg = f"Retrieval service: Unexpected error during context retrieval for user {user_id}: {type(e).__name__} - {str(e)}"
